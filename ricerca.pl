...
prova(Soluzione) :- 
    ...
    % assert((iterativeDeepening(StartingBoard,BlankPos, Depth, Solution):-
...
iterativeDeepening(StartingBoard,BlankPos, Depth, Solution):-
    ...
    assertz((nextMove(Position,[Move|MoveList],BlankPos,LastMove,MaxDepth):-
        MaxDepth > 0,
